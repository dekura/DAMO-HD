...
#SBATCH --output=/research/d4/gds/gjchen21/tmp/log/dls_haoyu_e100_m2c.txt
#SBATCH --gres=gpu:4
...
--dataroot /research/d4/gds/gjchen21/datasets/datasets/dlsopc_datasets/via_layouts_0.4_unpaired/dls_single \
--netG global \
--batchSize 4 \
