#!/bin/bash
#SBATCH --job-name=xlv2g41024
#SBATCH --mail-user=cgjhaha@qq.com
#SBATCH --mail-type=ALL
#SBATCH --output=/research/d2/xiaolin/tmp/log/orect2pixhd_e100_1024_good_dr2mg_D2d1.txt
#SBATCH --gres=gpu:4
...
--norm instance \
--data_type 8 \
--name orect2pixhd_e100_1024_good_dr2mg_D2d1 \
