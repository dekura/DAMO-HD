...
--dataroot /research/dept7/glchen/datasets/dlsopc_datasets/pix2l2rect/orect4pixhd_e100_1024_good_dr2mg_D1d1_fc5_CALI/dls \
--model pix2pixHD \
--netG global \
--resize_or_crop none \
--name orect4pixhd_e100_1024_good_dr2mg_D1d1_fc5 \
--loadSize 1024 \
--fineSize 1024 \
--which_epoch latest \
--how_many 10000 \
